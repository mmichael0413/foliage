...
function program3(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + " "
    + escapeExpression((helper = helpers.pluralize || (depth0 && depth0.pluralize),options={hash:{},data:data},helper ? helper.call(depth0, (depth0 && depth0.issue_count), "Issue Found", "Issues Found", options) : helperMissing.call(depth0, "pluralize", (depth0 && depth0.issue_count), "Issue Found", "Issues Found", options)))
    + "</h3>\n                <ul class=\"unstyled\">\n                    ";
